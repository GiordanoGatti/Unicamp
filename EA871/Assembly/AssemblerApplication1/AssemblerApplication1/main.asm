...
main:
sbi DDRB, 5 ;setar o bit 5 do ddrb, equivalente a porta 13 do arduino, conectada com o led do mesmo, definindo como saída(led que se deseja acender)
loop:
...
rjmp loop ;fecha um laço de loop infinito, fazendo com que o led pisque continuamernte
