...
load('dados_identificacao_ruido_gaussiano.mat')
x = x';
d = d';
...
plot(w(1,:), 'k')
plot(w(2,:), 'k')
title('Evolução dos coeficientes do filtro em função do número de iterações LMS \mu = 0.005')
...
plot(w(1,:), 'k')
plot(w(2,:), 'k')
title('Evolução dos coeficientes do filtro em função do número de iterações LMS sinal de erro \mu = 0.005')
%%
w0 = linspace(-2,2,1000);
w1 = linspace(-2,2,1000);
...
plot(w(1,:), 'k')
plot(w(2,:), 'k')
title('Evolução dos coeficientes do filtro em função do número de iterações RLS \lambda = 0.999')
%%
w0 = linspace(-2,2,1000);
w1 = linspace(-2,2,1000);
